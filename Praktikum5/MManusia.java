 ...
 * Deskripsi    : berisi main implementasi dari Manusia beserta semua subclass dari Manusia
...
public class MManusia {
    public static void main(String[] args) {
        PNS p1 = new PNS("Satriyo", LocalDate.of(2000, 1, 1), "Jl. Seroja", 15000000, "198302032006041002");
